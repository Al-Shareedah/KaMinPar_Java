...
set output "ccm_vs_skewness_pgp.eps"
...
# Plot the data
plot "data_ccm_pgp.txt" using 1:2 title "KaMinPar"         with linespoints ls 1, \
     "data_ccm_pgp.txt" using 1:3 title "KaHIP"            with linespoints ls 2, \
     "data_ccm_pgp.txt" using 1:4 title "ReNUP, {/Symbol d}=0"       with linespoints ls 3, \
     "data_ccm_pgp.txt" using 1:5 title "ReNUP, {/Symbol d}=780"     with linespoints ls 4
