...
set style line 3 lw 5 pt 5 ps 4 lc rgb "#2ca02c"   # Deep NUGP ε=0.0
set style line 4 lw 5 pt 13 ps 4 lc rgb "#d62728"  # Deep NUGP ε=780

# Left margin


# Plot the percentage improvement
plot "data_4elt_edgecut.txt" using 1:2 title "KaMinPar"             with linespoints ls 1, \
     "data_4elt_edgecut.txt" using 1:3 title "KaHIP (Baseline)"     with linespoints ls 2, \
     "data_4elt_edgecut.txt" using 1:4 title "ReNUP, {/Symbol d}=0.0"     with linespoints ls 3, \
     "data_4elt_edgecut.txt" using 1:5 title "ReNUP, {/Symbol d}=780"     with linespoints ls 4
