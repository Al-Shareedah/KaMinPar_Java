...
plot "data_pgp_edgecut.txt" using 1:2 title "KaMinPar"             with linespoints ls 1, \
     "data_pgp_edgecut.txt" using 1:3 title "KaHIP (Baseline)"     with linespoints ls 2, \
     "data_pgp_edgecut.txt" using 1:4 title "ReNUP, {/Symbol d}=0.0"     with linespoints ls 3, \
     "data_pgp_edgecut.txt" using 1:5 title "ReNUP, {/Symbol d}=534"     with linespoints ls 4
