...
set style line 4 lw 5 pt 13 ps 5 lc rgb "#d62728"  # ReNUP {/Symbol e}=57



# Plot new runtime data
plot "data_email_runtime.txt" using 1:2 title "KaMinPar"             with linespoints ls 1, \
     "data_email_runtime.txt" using 1:3 title "KaHIP"                with linespoints ls 2, \
     "data_email_runtime.txt" using 1:4 title "ReNUP, {/Symbol d}=0.0"     with linespoints ls 3, \
     "data_email_runtime.txt" using 1:5 title "ReNUP, {/Symbol d}=57"     with linespoints ls 4
