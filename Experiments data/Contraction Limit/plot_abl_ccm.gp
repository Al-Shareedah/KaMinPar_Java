...
set output 'abl_CCM.eps'

# Set title and labels
set title "Graph Size vs. CCM for ReNUP Variations" font ",26"
...
plot 'Abl_ccm.txt' using 0:2:xtic(1) with linespoints linestyle 1 title "ReNUP ({/Symbol d} = 0.0)", \
