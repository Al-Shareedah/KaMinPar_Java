...
set output 'edgecut.eps'

# Set title and labels
set title "Impact of Graph Size on Edge Cut" font ",26"
...
plot 'Exp4_edgecut.txt' using 0:2:xtic(1) with linespoints linestyle 1 title "KaMinPar", \
