...
set output 'abl_runtime.eps'

# Set title and labels
set title "Graph Size vs. Runtime for ReNUP Variations" font ",26"
...
set key top left inside font ",18"

# Plot as line plot with points
plot 'Abl_runtime.txt' using 0:2:xtic(1) with linespoints linestyle 1 title "ReNUP ({/Symbol d} = 0.0)", \
