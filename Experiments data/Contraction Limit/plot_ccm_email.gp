...
set title "Impact on CCM as {/Symbol d} varies (Email graph)" font ",30"
...
plot 'data_ccm_email.txt' using 1:2 with linespoints   linestyle 1 title 'ReNUP', \
'data_ccm_email.txt' using 1:3 with linespoints   linestyle 2 title 'KaMinPar', \
'data_ccm_email.txt' using 1:4 with linespoints   linestyle 3 title 'KaHIP'
